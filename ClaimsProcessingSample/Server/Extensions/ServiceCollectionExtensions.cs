using ClaimsProcessingSample.Application.Configurations;
...
using ClaimsProcessingSample.Application.Interfaces.Services.Account;
using ClaimsProcessingSample.Application.Interfaces.Services.Identity;
using ClaimsProcessingSample.Application.Models.Identity;
using ClaimsProcessingSample.Infrastructure;
using ClaimsProcessingSample.Infrastructure.Contexts;
using ClaimsProcessingSample.Infrastructure.Repositories;
using ClaimsProcessingSample.Infrastructure.Services;
using ClaimsProcessingSample.Infrastructure.Services.Identity;
using ClaimsProcessingSample.Infrastructure.Shared.Services;
using ClaimsProcessingSample.Server.Permission;
using ClaimsProcessingSample.Server.Services;
...
namespace ClaimsProcessingSample.Server.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ClaimsProcessingSample.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "ClaimsProcessingSample",
